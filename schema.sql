...
CREATE TABLE orders (
  ...
  status ENUM('pending', 'cancelled', 'pending_shipping', 'processing','payment_fail','payment_complete','shipped') DEFAULT 'pending',
...
-- ALTER TABLE orders MODIFY column_name new_data_type [constraints];
